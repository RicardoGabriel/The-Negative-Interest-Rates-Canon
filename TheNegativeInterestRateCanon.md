...
If consumers face negative interest rates, they have no incentive to save. Borrowing is more attractive, leading to an increase in spending, thereby facilitating an economic recovery. Negative interest rates could also have several **positive implications** on consumers. Let us look to some of them.
 
Firstly, the transfer of resources from net savers to net borrowers. As net borrowers typically have a higher marginal propensity to consume (i.e. they consume more for every unit of income that they earn than net savers encouraging consumption) they will buy more goods and services this leads to greater investment.
...
Since Banks now accept riskier loans, they could decide to compensate this risk by charging a security fee on each loan they lend out, essentially passing on the costs to the consumers. If instead, banks decide to absorb these costs, this could severely decrease their profits.
...
All of these factors also lead to an increase in money circulation,  which forces prices to go up. This increase in inflation could turn out to be harmful for low-income households, who are typically net savers.
 
Overall, the net effect that negative interest rates have on consumers is not cristal clear. While consumers can benefit when they are paid whenever they borrow, the same effect reverses if banks charge them with a fee, causing the effective interest rate to be zero. [#1] (http://www.advisoryhq.com/articles/negative-interest-rates/) [#2] (http://www.investopedia.com/articles/markets/080916/how-negative-interest-rates-can-affect-consumers.asp)
...
Bank of Japan (BOJ) first tried to stimulate country’s economy with a zero interest rate and quantitative easing programs. However, the result seemed to work only for a short period of time. For this reason, in early 2016, the BOJ decided to adopt a negative interest rate policy, with the expectation to achieve a 2% inflation rate. The BOJ has not only cut interest rate on excess reserve deposits to minus 0.1%, as it still maintains the quantitative easing program.[#] (http://www.japantimes.co.jp/news/2016/06/06/national/stimulus-efforts-struggle-abe-pushes-equal-pay-lift-japans-economy/#.WAnzEvmrhBc)
...
The **Eurozone** sovereign debt crisis began at the end of 2009, when eurozone member states Greece, Spain, Ireland, Portugal and Cyprus were unable to repay or refinance their government debt. As a result some countries did not fully recovered and the Eurozone is still facing a period of low inflation and low GDP growth. [#] (http://www.investopedia.com/terms/e/european-sovereign-debt-crisis.asp)
...
Fiscal policy is a tool used by Governments to target the value and composition of government spending and revenue. When a policy authority decides to lower taxes and increase spending, it is implicitly increasing the amount of money circulating, hooping to increase demand, investment and economic growth. 

Some economists argue that, instead of relying so much on monetary policy and hoping that Central Banks will boost the economic growth, governments should use fiscal policy to overcome stagnation. However, this tool also has several limitations. 

First, one must keep in mind that the government budget should be balanced - the value of revenues should equal more or less the value of spendings. So when a government faces economic stagnation and has already a considerable 
<b id="a17">[budget deficit](#f17)</b>, fiscal policy is somehow limited.

Second, if in this case it chooses to use an expansionary fiscal policy anyway, it will have an even higher budget deficit. This might mean that, in the future, the government will raise taxes and decrease spending to pay this debt. Moreover, households may be aware of this situation and, instead of spending the money they accumulated from the previous decrease in taxes, they will save it to face its future increase.
